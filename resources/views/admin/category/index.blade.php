        ...
        <div class="row">
         <div class="col">
                 ...
                 <div class="col">
                  <form action="{{route('category.store')}}" method="POST">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control mb-3" id="cat" placeholder="Enter Category">
             ...
             <div class="card container">
               <div class="row">
                <div class="col">
                  <table id="editable" class="table table-striped table-bordered" >
                      <thead>
                          <tr>
                              <th>#</th>
                              <th>Category</th>
                      ...
                      <tbody>
                        <?php $no=1; ?>
                          @forelse ($category as $row)
                              ...
                              @empty
                              <tr>
                                <td colspan="3">Tidak Ada Category</td>
                              </tr>
                          @endforelse
                      </tbody>
                  </table>
